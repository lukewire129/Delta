...
namespace Delta.WPF
{
    public class ApplicationRoot
    {
        ...
        private static readonly Dictionary<string, HookComponent> ComponentCache = new ();
        private static ApplicationRoot? _instance = new ();
        private HookComponent _rootComponent;
        ...
        public static void Initialize(HookComponent rootComponent, Window mainWindow)
        {
            _instance.InitializeInternal (rootComponent);
            _instance.InitializeInternal (mainWindow);
        }
        private void InitializeInternal(HookComponent rootComponent)
        {
        ...
        public static T GetOrCreateComponent<T>(T Comonent) where T : HookComponent
        {
