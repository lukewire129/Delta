        ...
        public override IVisual Render()
        {
            ...
            return Grid (
                     ...
                     Path ("M 0,0 L 103,0 L 118,14 L 103,28 L 0,28 C 10,14 0,0 0,0 Z")
                        ...
                        .Fill (() => 
                        {
                            var temp = hover? ArrowFillOver() : ArrowFill ();
                        ...
                        .Brush (hover? ArrowStrokeOver () : ArrowStroke())
                        .Thickness (2)
                        .Margin (40, 5, 4, -5)
                   ...
                   .OnHover ((s, e) =>
                   {
                       bool isHover = e.RoutedEvent == UIElement.MouseEnterEvent;
                   ...
                   .Cursor (hover ? Cursors.Hand : Cursors.No)
